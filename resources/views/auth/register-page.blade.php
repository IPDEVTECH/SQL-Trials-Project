        ...
        <div class="containerLR" style="background-image: url({{ asset('img/capa-fundo-login-register.png') }});">
            <div class="subcontainerLR">
                ...
                <div class="form">
                    <form class="formLR">
                        <div class="inputcontainer">
                            <input class="input100" data-input name="cep" id="cep" placeholder="CEP" maxlength="8"
                        ...
                        <div class="inputcontainer">
                            <input class="input100" type="text" name="address" id="address" placeholder="Rua" required
                                data-input>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                        </div>
                        ...
                        <div class="inputcontainer">
                            <input class="input100" type="text" name="neighborhood" id="neighborhood"
                        ...
                        <div class="inputcontainer">
                            <input class="input100" type="text" id="complement" name="complement"
                                placeholder="Complemento" required data-input>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                        </div>

                        <div class="inputcontainer">
                            <input class="input100" type="text" id="city" name="city" placeholder="Cidade" required
                                data-input>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                        </div>
